        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="post" enctype="multipart/form-data" action="{{ route('dapp_store') }}">
                        @csrf
                        <div class="form-group">
                            <label for="app_name">{{ __('common.dapp') }} {{ __('common.name') }} *</label>
                            <input type="text" name="app_name" class="form-control" id="app_name" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="dapp_status">{{ __('common.dapp') }} {{ __('common.status') }} *</label>
                            <select name="status" class="form-control" id="dapp_status">
                                <option value="0">{{ __('common.testing') }}</option>
                                <option value="1">{{ __('common.online') }}</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="app_descp" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="callback_url">{{ __('common.callback_url') }} *</label>
                            <input name="callback_url" type="text" class="form-control" id="callback_url" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="withdraw_addr">{{ __('common.withdraw_addr') }} *</label>
                            <input name="withdraw_addr" type="text" class="form-control" id="withdraw_addr" placeholder="">
                        </div>
                        <div class="form-group">
